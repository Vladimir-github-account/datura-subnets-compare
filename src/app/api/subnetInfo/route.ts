...
type contributors = Endpoints["GET /repos/{owner}/{repo}/contributors"]["response"];
...
export async function GET(req: NextRequest) {
  try {
    ...
    const { data: contributors } = await axios.get<contributors["data"]>(repoData.contributors_url, config);
